# test_consultar_cobranca_com_vencimento.py
...
class TestConsultarCobrancaComVencimento(unittest.TestCase):
    ...
    def test_01_consultar_cobranca_com_vencimento_success(self, mock_https_connection):
        ...
        # Instancia a classe ConsultaCobrancaComVencimento
        consulta_cobv_vencimento = ConsultaCobrancaComVencimento(
            Environment.SANDBOX,
            self.client_id,
            self.client_secret,
            self.cert,
        ...
        data = consulta_cobv_vencimento.consultar("655dfdb1a4514b8fbb58254b958913fb")
    ...
    def test_02_consultar_cobranca_com_vencimento_failure(
        self, mock_https_client_class
    ):
        """Teste de consulta de cobranca com vencimento com txid inválido"""

        consulta_cobranca = ConsultaCobrancaComVencimento(
            Environment.SANDBOX,
            self.client_id,
            self.client_secret,
            self.cert,
