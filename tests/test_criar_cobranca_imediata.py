...
class TestCriarCobrancaImediata(unittest.TestCase):
    ...
    def test_02_criar_cobranca_imediata_failure(self, mock_https_client_class):
    ...
    @patch("http.client.HTTPSConnection")  # Mocka a classe MyHttpsClient
    def test_03_criar_cobranca_imediata_chave_failure(self, mock_https_client_class):
        """Teste de lançamento de exception"""
