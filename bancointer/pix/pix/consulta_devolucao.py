...
class ConsultaDevolucao(object):
    def __init__(
        self,
    ...
    def consultar(self, e2e_id: str, cli_id: str):
        """Metodo para consultar uma devolução através de um E2EID do Pix e do ID da devolução.
        ...
        try:
            ...
            response = self.http_util.make_get(
                f"{PATH_PIX_PIX}/{e2e_id}/devolucao/{cli_id}"
            )
