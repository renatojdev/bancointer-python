...
class ConsultaCobrancaImediata(object):
    def __init__(
        self,
    ...
    def consultar(
        ...
        """Metodo para consultar uma cobrança através de um determinado txid.
        ...
        Returns:
            RespostaSolicitacaoCobrancaImediata (dict): object com os dados da cobrança imediata
        ...
        try:
            ...
            print(f"BancoInterException.ConsultaCobrancaImediata.consultar: {e}")
            return e.erro.to_dict()
        except Exception as e:
            print(f"Exception.ConsultaCobrancaImediata: {e}")
